// fallhome-us-api · Express HTTP wrapper around fallhome-us-sdk · MIT · AI-Native Solutions
import express from 'express';

const app = express();
app.use(express.json({ limit: '10mb' }));

app.get('/health', (_req, res) => res.json({ ok: true, tool: 'fallhome-us', version: '1.0.0' }));
...
app.listen(PORT, () => console.log('fallhome-us-api listening on :' + PORT));
